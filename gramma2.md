...
1. 小句1ば，小句2
    ...
    原则上小句2不饿能出现意志希望命令请求，和と一样

    小句1是 __状态性谓语__ ，__小句1和小句2主语不同__ 时可以使用

    状态性谓语 いる　ある　できる　表达状态

    很复杂的特例，建议不看，使用たら

        部屋がもう少し広ければいいのですが
        雨が降らないければ、ハイキングに行きましょう
        日本語のテストで、９０点以上取れば、夏休みに旅行へ行きましょう
2. 小句简体なら、小句2

    根据对方的言谈或交谈时的现场情况来陈述自己的主观立场（形2和名词去だ+なら）

    但特例是 __形2和名词__ 要去は, __ではなかった -> でなかった__

        
        今日は忙しいですが。忙しいなら、行かなくてもいいですよ
        彼が犯人でないなら、すぐ釈放してください
3. 名词でも

    询问较多，偶尔自言自语（17，35也提到此语法的其他含义）一般不用于过去式
...
4. 小句1とか小句2とか
    ...
    や-など只能用于名词的列举，是书面语口语通用

        コートとか靴とか、たくさん買いました
        海外りょこに行きたいとか、新しい車が欲しいとか、ぜいたくなことばかり言っています
## 表达及词语详解
1. 假定

    31と　35たら　37ば　37なら的总结

    とば后面基本不能请求和建议
    此处一个表格，用于总结 很麻烦的语法多复习
2. ちゃった 是 てしまった的口语形式 33
3. ２時間ちょっとですね
